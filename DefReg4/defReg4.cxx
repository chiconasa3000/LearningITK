...
int main(int argc, char * argv[])
{
	...
	// the registration.
	//
	// No es necesario realizar una diferencia de imagen mediante la transformacion de puntos de la imagen fija
	// ni tampoco realizar la resta entre puntos transformados y puntos originales.
	// Para ello existe el TransformToDisplacementFieldFilter
	...
	using DisplacementFieldGeneratorType = itk::TransformToDisplacementFieldFilter<DisplacementFieldImageType, CoordinateRepType>;
